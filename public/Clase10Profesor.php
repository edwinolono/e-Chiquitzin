...
<htm>
    <head>
        <title>Clase 10 contemos hasta 15 Profesor</title>
        ...
        <div class="container">
            <div class="left-aside" style="background-color: rgb(238, 139, 9); border-radius: 15px; position: relative; left: 45px;">
                ...
                <div style="background-color: azure; border-radius: 15px; width: 90%; height: auto; position: relative; left: 25px;">
                    ...
                    Había <input type="number" min="0" max="15"> flores, pusieron <input type="number" min="0" max="15">, ahora hay<input type="number" min="0" max="15"><br>
                    <img src="../../images/Clase 10 img 2.png" style="width: 150px; height: 150px; position: relative; "><br>
                    Había <input type="number" min="0" max="15"> pajaros enjaulados, pusieron <input type="number" min="0" max="15">, ahora hay<input type="number" min="0" max="15"><br>
                </div>
            </div>
            <div class="right-aside" style="background-color: rgb(238, 139, 9); border-radius: 15px; position: relative; left: 200px;">
                ...
                <div style="background-color: azure; border-radius: 15px; width: 90%; height: auto; position: relative; left: 25px;">
                    ...
                    El yoyo costaba <input type="number" min="0" max="15"> Raúl tenía <input type="number" min="0" max="15">solo le faltaban<input type="number" min="0" max="15"><br>
                    <img src="../../images/Clase 10 img 4.png" style="width: 200px; height: 200px; position: relative; "><br>
                    La caja tenía <input type="number" min="0" max="15"> fichas, pusieron <input type="number" min="0" max="15"s>, ahora hay<input type="number" min="0" max="15"><br>
